...
file_name_tot_hh = '2016Census_G30_VIC_SA3.csv' #hh, vel
file_name_tot_pp = '2016Census_G01_VIC_SA3.csv' #genders, pp, age gr
file_name_tot_work = '2016Census_G43B_VIC_SA3.csv' #work

if __name__ == '__main__':
    folder_path = r'C:\Users\dlaa0001\Documents\Work\PhD\achilles\popsim\data\source\2016_GCP_all_for_VIC_short-header\2016 Census GCP All Geographies for VIC\SA3\VIC' + "\\"
